    ...
    return (
        <div className="relative z-50">
            <button
                ...
                className="bg-gray-950 text-white font-medium h-10 w-70 py-2 px-4 rounded-lg shadow-md flex justify-between items-center hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            >
            ...
            {menuOpen && (
                <div className="absolute top-full left-0 mt-2 w-full bg-gray-700 rounded-md shadow-lg py-1 z-50">
